...
onready var Bricks = get_node("/root/Game/Bricks")
...
func _ready():
	...
	$Menu/Ball/Ball_Size.pressed = true
...
func _on_Ball_Size_toggled(button_pressed):
	ball_size = button_pressed
	emit_signal("changed")



func _on_Blocks_rotation_pressed(button_pressed):
	#print (button_pressed)
	blocks_rotation = button_pressed
	emit_signal("changed")
